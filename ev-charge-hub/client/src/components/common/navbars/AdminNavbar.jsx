    ...
    <nav className="bg-blue-600 text-white shadow-md sticky top-0 z-50">
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2 bg-blue-600 text-white flex flex-col">
          ...
          <Link to="/admin/registered-users" onClick={toggleMenu} className="block hover:underline">View Users & Bookings</Link>
          <Link to="/admin/my-profile" onClick={toggleMenu} className="block hover:underline">My profile</Link>
