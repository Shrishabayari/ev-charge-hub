...
const Homepage = () => {
    ...
    return (
        ...
        @media (min-width: 768px) {
            ...
            <Navbar />
            <main className=" text-gray-800 font-inter overflow-hidden">
                <section id="hero" class="relative bg-gradient-to-br from-blue-50 via-indigo-100 to-blue-200   py-24 md:py-32 px-6 gradient-move">
                ...
                <div class="md:hidden flex justify-center mb-8 hero-image-enter-active">
                    <div class="floating-element">
                        <img
                            ...
                            class="rounded-3xl shadow-2xl w-full max-w-sm border-4   transform hover:scale-105 transition-transform duration-500 backdrop-blur-sm"
            ...
            <div class="hidden md:flex flex-1 justify-center md:justify-end mt-12 md:mt-0 hero-image-enter-active">
                <div class="floating-element">
                    <img
                        src="https://img.freepik.com/free-vector/electric-car-charging-station-concept-illustration_114360-8227.jpg"
                        alt="EV Charging Station"
                        class="rounded-3xl shadow-2xl w-full max-w-md border-4 border-white/3 transform hover:scale-105 transition-transform duration-500 backdrop-blur-sm"
                        onerror="this.onerror=null; this.src='https://placehold.co/600x400/E0E7FF/3F51B5?text=EV+Charging'"
                    />
                    <div class="absolute -top-6 -left-6 w-12 h-12 bg-blue-500 rounded-full opacity-70 animate-pulse"></div>
                    <div class="absolute -bottom-4 -right-4 w-8 h-8 bg-indigo-400 rounded-full opacity-60 animate-bounce"></div>
                ...
                <section id='about-us' className="min-h-screen bg-white  py-16 px-6 md:px-20">
                    <div className="max-w-6xl mx-auto">
                        {/* Enhanced Introduction */}
                        <AnimatedSection className="text-center mb-12">
                            <h1 className="text-5xl font-extrabold mb-4 text-blue-70 animate-slideInFromTop">
                                About EV Charge Hub
                            </h1>
                            <p className="text-xl text-gray-600  max-w-2xl mx-auto animate-fadeIn">
                        ...
                        <div className="grid md:grid-cols-2 gap-10 mt-10">
                            <AnimatedSection delay={300}>
                                <div className="card-hover   p-8 rounded-lg shadow-lg border border-gray-100 animate-slideInFromLeft">
                                    <h2 className="text-3xl font-bold mb-4 text-blue-600  animate-zoomIn">Why EV Charge Hub?</h2>
                                    <ul className="list-disc ml-6 space-y-3 text-base text-gray-700 ">
                            ...
                            <AnimatedSection delay={400}>
                                <div className="card-hover bg-gray-50 p-8 rounded-lg shadow-lg border border-gray-100 animate-slideInFromRight">
                                    <h2 className="text-3xl font-bold mb-4 text-blue-600 animate-zoomIn">Our Vision</h2>
                                    <p className="text-base leading-relaxed text-gray-700 animate-fadeIn">
                ...
                <section id="how-it%20works" className="py-24 px-6 md:px-12 lg:px-24 bg-gray-50 text-gray-800">
                    <div className="max-w-7xl mx-auto">
                        <AnimatedSection>
                            <h2 className="text-4xl lg:text-5xl font-extrabold text-center text-blue-700 mb-16">
                        ...
                        <div className="space-y-12">
                            {steps.map((step, index) => (
                                <AnimatedSection key={index} delay={index * 100}>
                                    <div className={`card-hover flex flex-col md:flex-row items-center md:space-x-10 p-10 bg-white rounded-3xl shadow-xl border border-gray-100  ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                                        <FloatingElement className={`text-6xl md:text-7xl flex-shrink-0 mb-6 md:mb-0 ${index % 2 === 0 ? 'text-blue-500' : 'text-emerald-500'} feature-icon-bounce`}>
                                            {step.icon}
                                        </FloatingElement>
                                        <div className={index % 2 === 0 ? 'text-center md:text-left' : 'text-center md:text-right'}>
                                            <h3 className="text-3xl font-bold text-gray-900 mt-2 md:mt-0 mb-3">{`${index + 1}. ${step.title}`}</h3>
                ...
                <section id="features" className="py-24 px-6 md:px-12 bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-50 ">
    <div className="max-w-7xl mx-auto">
        <AnimatedSection>
            <h2 className="text-4xl lg:text-5xl font-extrabold text-slate-90 mb-8 animate-fade-in-down text-center">
                Unlock the Power of Seamless EV Charging
            </h2>
            <p className="text-lg md:text-xl text-slate-600 animate-fade-in-down delay-100 mb-20 text-center max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
            {[
                ...
                <StaggeredAnimation key={index} index={index}>
                    <div className="feature-card-hover pt-12 bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl border border-slate-200/60 h-full transition-all duration-300">
                ...
                <section id="faq" className="py-24 px-6 md:px-12 bg-gray-50">
                    <div className="max-w-4xl mx-auto">
                        <AnimatedSection>
                            <h2 className="text-4xl lg:text-5xl font-extrabold text-center text-blue-70 mb-16">
                        ...
                        <div className="space-y-6">
                            {faqData.map((faq, index) => (
                                <AnimatedSection key={index} delay={index * 100} className="bg-white p-6 rounded-2xl shadow-lg border border-gray-1 ">
                                    <div className="faq-item">
                                        <button
                                        className="flex justify-between items-center w-full text-left text-2xl font-semibold text-gray-900  focus:outline-none"
                                    ...
                                    {activeIndex === index && (
                                        <p className="mt-4 text-lg text-gray-700  leading-relaxed animate-fade-in">
                                            {faq.answer}
                                        </p>
                                    )}
                                    </div>
                ...
                <section id="contact" className="py-24 px-6 md:px-12 bg-white">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid lg:grid-cols-2 gap-12">
                            ...
                            <AnimatedSection delay={200}>
                                <div className="space-y-8">
                                    {[
                                        ...
                                        <StaggeredAnimation key={index} index={index}>
                                            <div className="contact-card bg-gray-50  p-6 rounded-xl border border-gray-100 ">
                            ...
                            {/* Contact Form */}
                            <AnimatedSection delay={400}>
                                <div className="form-floating bg-gray-50 p-8 rounded-2xl border border-gray-100">
                                    <form onSubmit={handleSubmit} className="grid gap-6 p-6 md:p-8 bg-white rounded-lg shadow-xl border border-gray-100">
                                        <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full px-5 py-3 rounded-lg bg-gray-100 border border-gray-300 focus:outline-none focus:ring-3 focus:ring-blue-500 focus:border-transparent text-gray-900  placeholder-gray-400 transition duration-200"
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="w-full px-5 py-3 rounded-lg bg-gray-100 border-gray-300  focus:outline-none focus:ring-3 focus:ring-blue-500 focus:border-transparent text-gray-900  placeholder-gray-400  transition duration-200"
                                        ...
                                        <textarea
                                            ...
                                            rows="6"
                                            required
                                            className="w-full px-5 py-3 rounded-lg bg-gray-100 border border-gray-300  focus:outline-none focus:ring-3 focus:ring-blue-500 focus:border-transparent text-gray-900  placeholder-gray-400  resize-y transition duration-200"
                                        ...
                                        {status === "error" && (
                                        <p className="text-red-600 mt-2 text-center">Error sending message. Please try again.</p>
                                        )}
                                    </form>
                                </div>
                            </AnimatedSection>
