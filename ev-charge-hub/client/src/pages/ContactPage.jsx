...
const Contact = () => {
  ...
  return (
    <div>
      <Navbar />
      <section className="min-h-screen bg-white  text-gray-800  py-16 px-6 md:px-20 flex items-center justify-center">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 bg-gray-50  p-8 md:p-12 rounded-xl shadow-2xl">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="space-y-6 mt-8">
              ...
              <div className="p-4 bg-white  rounded-lg shadow-md border border-gray-100 ">
                ...
                <a href="mailto:support@vrechargehub.com" className="text-blue-600  hover:underline text-lg">support@evrechargehub.com</a>
              </div>

              <div className="p-4 bg-white  rounded-lg shadow-md border border-gray-100 ">
                <h3 className="text-xl font-semibold text-gray-900  mb-1">Call Us</h3>
                <p className="text-lg text-gray-700 ">+91-9876543210</p>
              </div>

              <div className="p-4 bg-white  rounded-lg shadow-md border border-gray-100 ">
                <h3 className="text-xl font-semibold text-gray-900  mb-1">Our Location</h3>
                <p className="text-lg text-gray-700 ">Udupi, Karnataka, India</p>
              </div>
            </div>
          </div>
